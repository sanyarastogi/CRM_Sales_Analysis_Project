...
---
# Overview
- Analyzed a B2B CRM sales pipeline dataset to uncover insights on revenue, win rates, sales performance, and pipeline health using Excel, SQL Server, and Power BI.
---
# Project_Assests
